...
movie_subtitles/
  ...
  dub.py                  # scene-anchored TTS synthesis (fit_rate, synthesise_track):
                           ...
                           # default 8); results are collected by submission index so
  ...
  providers/
    base.py                # Segment dataclass + ASRProvider / TranslationProvider /
                            ...
                            # — plus FallbackAlign, which composes AlignmentProviders into
                            # a threading.Lock-guarded degrade chain (dub.py now calls the
                            # aligner concurrently)
