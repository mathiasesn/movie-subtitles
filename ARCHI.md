...
movie_subtitles/
  ...
  dub.py                  # scene-anchored TTS synthesis (fit_rate, synthesise_track):
                           ...
                           # default 1 = serial; argparse rejects values below 1). Each
