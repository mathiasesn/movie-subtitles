...
**Cost:** because underruns are now re-synthesised too, a dub run makes up to two paid TTS calls per segment rather than one; previously only overrunning segments paid twice.
