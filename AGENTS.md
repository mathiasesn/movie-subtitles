...
movie_subtitles/
  ...
  mux.py           # mux_dub(): overlays the finished audio track over the source video
                    ...
                    # (amix=normalize=0) and ducked to duck_level (--duck-level, default
                    # _DUCK_LEVEL = 0.25) inside the caller's speech_spans, with a
                    # per-input gain guarding against clipping. A
