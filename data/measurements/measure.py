...
def main():
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "Costs real money (~$0.01 ElevenLabs + Anthropic translation of "
            "~16 short segments). Default is off."
        ),
    )
    ...
    if not args.rerun_paid:
        print(
            "\nSkipping the unconstrained en->da expansion-ratio figure "
            "(requires --rerun-paid; costs ~$0.01 ElevenLabs ASR + Anthropic "
            "translation of ~16 short segments)."
        )
        print("\n--- SUMMARY ---")
